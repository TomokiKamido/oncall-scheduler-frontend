...
exports.setCustomUserClaimsCallable = exports.setCustomUserClaims = void 0;
 ...
 */
exports.setCustomUserClaimsCallable = functions
    .region(region)
    .https
    ...
    if (!uid || !customClaims) {
        throw new functions.https.HttpsError('invalid-argument', 'UID and customClaims are required.');
    }
    try {
        // 1. ユーザーの存在確認
        ...
        throw new functions.https.HttpsError('internal', 'Failed to update custom claims', error instanceof Error ? error.message : 'Unknown error');
    }
});
//# sourceMappingURL=setCustomUserClaims.js.map