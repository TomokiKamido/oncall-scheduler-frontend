 ...
 */
export const processRoleRequest = functions
  .region(region)
  .firestore
  ...
  .onWrite(async (change, context) => {
    ...
    try {
      ...
      const data = change.after.data() as RoleRequestData;
 ...
 * 動作確認用
 */
export const testRoleRequest = functions
  .region(region)
  .https
  .onRequest(async (req, res) => {
    ...
    try {
      ...
      const roleRequestData: RoleRequestData = {
